...
- (void)viewDidLoad
{
    ...
    NSString *plistPath=[bundle pathForResource:@"artistalbums" ofType:@"plist"]; // Retrieve the path of artistalbums.plist
    ...
    self.artistAlbums=dictionary; // Assigns the dictionary to artistAlbums
    NSArray *components = [self.artistAlbums allKeys]; // Retrieve the left component with the artist names
    ...
    self.albums = array; //populate the right component with the album names
}
